    ...
    public MainWindow()
    {
        if (!OperatingSystem.IsWindowsVersionAtLeast(10, 0, 17763))
        {
            throw new InvalidOperationException(
                "Hoppla! Diese Funktion ben�tigt Windows 10 (Version 1809) [mindestens 10.0.17763]oder neuer. Bitte aktualisiere dein Betriebssystem, um dieses Feature nutzen zu k�nnen.");
        }

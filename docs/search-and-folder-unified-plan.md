...
- FR-4: Suchprofile (Für mich/Für alle) — **Partialy DONE** (Backend-CRUD für Suchprofile und Saved Views inkl. Sichtbarkeit `private/global` umgesetzt; Frontend-Integration und Speichern/Laden im Studio noch offen).
...
7. Spotlight Phase 3: Suchprofile (Für mich/Für alle) — **Partialy DONE** (Backend-Endpunkte für Search Profiles und Views vorhanden; UI-Workflows und produktive Aktivierung noch offen).
